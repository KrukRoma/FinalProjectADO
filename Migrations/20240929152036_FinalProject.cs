            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PopularityWeek = table.Column<int>(type: "int", nullable: false),
                    PopularityMonth = table.Column<int>(type: "int", nullable: false),
                    PopularityYear = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
